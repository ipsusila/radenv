#ifndef XACTIONBUTTON_H
#define XACTIONBUTTON_H

// source, http://qt-project.org/wiki/PushButton_Based_On_Action
...
/*!
  ...
  * is triggered.
  */
class XActionButton : public QPushButton
{
    Q_OBJECT
...
public:
    /*!
      ...
      */
    explicit XActionButton(QWidget *parent = 0);
